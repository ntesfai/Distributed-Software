...
public class WaypointLibrary implements JSONString {
    ...
    public void addWpt(String name, double lat, double lon, double ele, String addr) {
    ...
    public boolean modLib(String name, double lat, double lon, double ele, String addr)    {
    	boolean found = false;
    	Waypoint wpt = new Waypoint(lat, lon, ele, name);
    	wpt.address = addr;
	int indx = 0;
