 ...
 * This software is meant to run on MacOS, and Linux using g++ compiler.
 * <p/>
...
protected:
   ...
   Fl_Button *modWPButt, *removeWPButt, *addWPButt, *importButt, *exportButt, *distBearButt;
...
public:
   WaypointGUI(const char* name = 0) : Fl_Window(520,300,name) {
      ...
      importButt = new Fl_Button(50, 185, 140, 25, "Import Library");
      exportButt = new Fl_Button(50, 220, 140, 25, "Export Library");
